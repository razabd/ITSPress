...
func processPDF(pub *Publication, encrypter crypto.Encrypter, contentKey string, pdfNoMeta bool) error {
	...
	// coverPath hanya diisi jika ExtractCover true.
	// Bila kosong, extractRWPInfo (termasuk stub nofitz) tidak akan membuat
	// file cover, sehingga BuildRPFFromPDF tidak mencoba membuka file yang tidak ada.
	var coverPath string
	if pub.ExtractCover {
